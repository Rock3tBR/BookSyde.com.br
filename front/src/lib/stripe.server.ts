...
export type StripeWebhookScope = "payments" | "marketplace";

export async function verifyWebhook(
  req: Request,
  env: StripeEnv,
  scope: StripeWebhookScope = "payments",
  ...
  const secret =
    scope === "marketplace"
      ? env === "sandbox"
        ? getEnv("MARKETPLACE_SANDBOX_WEBHOOK_SECRET")
        : getEnv("MARKETPLACE_LIVE_WEBHOOK_SECRET")
      : env === "sandbox"
